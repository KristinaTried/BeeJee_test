<?php 
	session_start();
	if($_SESSION['user'] == 'admin') header("Location: admin.php");
	...
	<div class="main_content">
		<div class='login_admin'> 
			<div class="form_auth_admin" data-show='false'>
				<input type="text" id="form_auth_login" placeholder="Логин">
				<p><input type="password" id="form_auth_password" placeholder="Пароль">
